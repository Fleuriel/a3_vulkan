...
VkResult VkAppBase::createInstance(bool enableValidation)
{
	...
	///@@@William Add VK_KHR_get_physical_device_properties2
	//std::vector<const char*> instanceExtensions = { VK_KHR_SURFACE_EXTENSION_NAME };
	std::vector<const char*> instanceExtensions = { VK_KHR_SURFACE_EXTENSION_NAME , "VK_KHR_get_physical_device_properties2" };
...
{
// SRS - for non-apple plaforms, handle benchmarking here within VkAppBase::renderLoop()
...
VkAppBase::VkAppBase()
{
	...
	//@@@william
	commandLineParser.add("sourcefile", { "-sf", "--sourcefile" }, 1, "load ktx format source file for image processing");
...
// SRS - Window resizing already handled by windowResize() in VkAppBase::submitFrame()
...
void VkAppBase::getEnabledExtensions() {}
...
#if defined(_WIN32)
void VkAppBase::OnHandleMessage(HWND hWnd, UINT uMsg, WPARAM wParam, LPARAM lParam) {};
#endif